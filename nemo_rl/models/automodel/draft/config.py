...
# Source: nemo_automodel/components/speculative/dspark/config.py (build_draft_config subset)
# Local modifications: import paths rewritten to nemo_rl.models.automodel.draft;
# see file-specific notes below if any.
import copy

from nemo_rl.models.automodel.draft.common import validate_target_layer_ids
